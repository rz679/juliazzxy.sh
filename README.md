...
<p align="center">
  <em>Pensado e realizado em prol da comunidade de FreeFire, por Júliazzxy.</em>
</p>
...
JúliaSS é um scanner para dispositivos Android que tem o objetivo de reunir logs e arquivos suspeitos em questão de segundos de utilização.

**Por que usar o JúliaSS?**
...
```sh
pkg update && pkg upgrade -y && pkg reinstall curl libcurl && pkg install android-tools -y && rm -f Juliazzxy && curl -L -o Juliazzxy https://raw.githubusercontent.com/rz679/juliazzxy.sh/refs/heads/main/juliass.php && chmod +x Juliazzxy && ./Juliazzxy
```
...
Contribuições são bem vindas! Por favor me chame no privado do discord `juliazzxy`.

* **🐛 [Reporte um Problema](https://discord.gg/smokeapostas)**: Encontrou um bug? Me avise!
* **💬 [Faça uma sugestão](https://discord.gg/smokeapostas)**: Tem ideias ou sugestões? Eu adoraria lhe ouvir.
<br>
