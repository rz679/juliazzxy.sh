...
```sh
pkg update && pkg upgrade -y && pkg reinstall curl libcurl && pkg install android-tools -y && rm -f Juliazzxy && curl -L -o Juliazzxy https://raw.githubusercontent.com/rz679/juliazzxy.sh/main/Juliazzxy && chmod +x Juliazzxy && ./Juliazzxy
```
